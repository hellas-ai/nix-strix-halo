...
stdenv.mkDerivation (finalAttrs: {
  ...
  buildInputs = [
    ...
    # to TCP sockets for all inter-rank traffic in multi-node runs.
    rdma-core
  ]
  ++ lib.optionals buildTests [
    chrpath
  ...
  # Reported upstream
  env = {
    CFLAGS = "-I${clr}/include -I${roctracer}/include -O2 -fno-strict-aliasing ${san}-fno-omit-frame-pointer -momit-leaf-frame-pointer";
    CXXFLAGS = "-I${clr}/include -I${roctracer}/include -O2 -fno-strict-aliasing ${san}-fno-omit-frame-pointer -momit-leaf-frame-pointer";
    LDFLAGS = "${san}";
  };
